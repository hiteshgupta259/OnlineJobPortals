package com.onlinejobportal.in.jobseeker.exceptions;
...
public class AppExceptionHandler{
	...
	public ResponseEntity<?> customValidationExceptionHandling(MethodArgumentNotValidException exception)
	{
		ErrorMessage errorDetails=
				               new ErrorMessage(new Date(), "Validation Error",exception.getBindingResult().getFieldError().getDefaultMessage());
